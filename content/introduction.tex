...
About $0.19-0.30$ GtC yr$^{-1}$ of \ce{CO2} get absorbed by the coastal ocean according to recent studies \citet{laruelleRegionalizedGlobalBudget2014, Bauer2013, Roobaert2024, Regnier2022, Dai2022}
% \begin{enumerate}
%  \item Coastal Oceans as the interface between Land and Ocean
%  \item high biological activity, high primary production
% \end{enumerate}

Coastal Oceans are a unique environment in the global ocean fullfilling multiple roles in various ecosystem services.
Especially their role in the Carbon Cycle has drawn more and more interest in recent years.

Being a interface between Land and open ocean the coast is the point where the river discharge enters the oceanic system and affects local biogeochemical processes.
This river influx is mainly dependent by the rivers discharge, governed by flow speed and size.
With the supply of chemicals of various types the discharge affects the local steady-state chemistry and it is expected that river discharge will be affected by climate change and human activity due to changes in groundwater and precipitation as well as chemical waste from humans and agriculture.
Riverine Estuaries therefore also present a special case in the coastal oceans, emitting about $0.2 - 0.4\;\text{PgC/y}$ even though they only cover a area of $0.2\%$ of the global ocean.
One of the reasons of high productivity and Carbon uptake in the coastal oceans is the different structure of marine and terrestrial carbon (supplied by rivers).

In biogeochemical ocean models the net primary production of phytoplankton typically follows the experimentally derived Redfield Ratio.
This Redfield Ratio is the fixed molar ratio of main chemical elements in living Cells.
...
\end{equation}
From this end-product, we can see the relation of $ \text{C:N:P:}\ce{O2} = 106:16:1:-138$, which is the so-called Redfield Ratio, which was measured by Redfield for C:N:P to estimate \ce{O2}.
...
Interestingly the Redfield Ratio for oceanic plankton is different than the stoichiometry of terrestrial produced organic matter.
Terrestrial organic matter (TOM) usually has higher C:N Ratios of $30:1$ or $60:1$ compared to oceanic organic matter with a C:N Ratio of about $7:1$.
The stoichiometry of carbon production and decomposition affects the metabolic balance of a oceanic ecosystem, prescribing if it is heterotrophic or autotrophic and therefore affecting the systems atmospheric carbon uptake.
If terrestrial carbon enters the coastal ocean and is respired by bacteria, there is a production of 30 to 60 moles of inorganic carbon per mole of nitrogen produced.
If phytoplankton recycle all of the nitrogen through primary production, only 7 moles of the 30-60 moles is recycled.
Due to this inbalance, there is more $\ce{CO2}$ produced in river plumes than can be taken up by the local phytoplankton.
Therefore river systems with high TOM influx will tend to be more heterotrophic than other coastal areas.
Additionally this balance depends on the speed of TOM decomposition (days to years), algal organic matter decomposition (hours to months), and algal primary production (hours to days) relative to the residence time of the water.
...
During the recent industrialization the atmospheric carbon dioxide concentration has risen in unpresedented amounts leding to a historical high in atmosperic carbon.
The biggest buffer and storage for atmospheric carbon is the ocean, taking up a major amount of anthropogenically produced carbon.
The anthropogenic $\ce{CO2}$ is taken up in the oceans surface and increases to surface concentration of carbon dioxide.
In the salty ocean water the diluted $\ce{CO2}$ quickly reacts chemically and a equilibrium of chemical reactions is formed, transforming the diluted gas in various forms of diluted inorganic carbon.
One of the major affects of these Reactions is their influence on the Oceans pH and the carbonate saturation in the ocean.
This shift in carbonate chemistry has led to a reduction in ocean pH and to a decrease in carbonate saturation.

The various components of this system of inorganic carbon in the seawater is usually described by Dissolved Inorganic Carbon (DIC) consisting of:
\begin{equation*}
  \ce{DIC = \sum CO2 = TCO2 = C_T}
\end{equation*}
Typically surface water relation of the DIC substitutes results in only $0.5\%$ Carbon Dioxide, $89\%$ Bicarbonates and $10.5\%$ Carbonate Ions.
% Additionally another Faktor influencing the oceans ability to uptake atmospheric carbon is its buffering capacity, which is strongly determined by Total Alkalinity (TA).
The Total Alkalinity (TA) is calculated by the charge balance of the water as follows $$A_T = \ce{[HCO3]- + 2[CO3^2-] + [B(OH)4-] + [OH-] - [H+] +} \; \text{minor compunds}$$ it gives the ability of the seawater to resist acidification and therefore bufferes the effect of carbon dioxide uptake and ocean acidification. 
...
$\ce{CaCO3}$ saturation state in SW is defined by
$$\Omega = \frac{[\ce{Ca^2+}]_{\text{SW}} \times [\ce{CO3^2-}]_{\text{SW}}}{K_{\text{Sp}}^*}$$
With the solubility product $K_{\text{Sp}}^*$ of calcite or aragonite at the specific state of the surrounding water, since $K_{\text{Sp}}^* = K_{\text{Sp}}^*(T,S,p)$
If $\Omega > 1$ the water is considered supersaturated, and undersaturated if  $\Omega < 1$.
For Calcite the solubility product $K_{\text{Sp}}^*$ increases with pressure resulting in a supersaturation in surface waters and undersaturation in the deeper ocean.
The Carbonate Ion concentration in Seawater is connected to DIC and Alkalinity.

The carbonate saturation state is a  very strong indicator for carbonate shell producing specie's health in the ocean and therefore a indicator for ecosystem wellbeing since these plankton and crustaceons sit on the bottom of the food chain as a supply for varoius other higher trophic levels.
If the CSS drobs below the threshold of 1 the water becomes undersaturated and shell producing organisms need to use considerably more energy to build their protection, with strong undersaturation the shell can even dissolve into the surrounding seawater, both the energy consumption or the loss of their shell can inevitably lead to the death of the organisms.
Even small changes in the Carbonate System can have big impacts on the Carbonate ion concentration and therefore strongly affect the CSS, making it a sensitive metric as well.


Especially in Coastal oceans we have a strong biodiversity of species of all trophic levels and Plankton builds the base building block for this intricate food web.
The present changes in DIC, TA, T and S due to riverine input strongly affect local pH levels and CSS and make the shelf sea a highly interesting region to study processes of ocean acidification. 
